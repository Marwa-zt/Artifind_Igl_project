...
const Aprop = () => {
    return (
        ...
        <div className=" text-black">
            ...
            <div className='border border-gray-700 rounded-3xl pb-12 px-4 mx-10'>
            ...
            <div className="md:text-3xl sm:text-xl text-xl my-4 py-9 border border-gray-700 rounded-3xl pb-12 px-4 mx-10">
                <div class="relative flex justify-center items-center py-20">
