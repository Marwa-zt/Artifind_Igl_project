    ...
    return (  
        ...
        <div className=" text-white py-6 px-6 mx-10 lg:mx-40 border border-gray-300 rounded-xl flex flex-col">
            <div className="flex items-center justify-center">
                <h1 className="font-bold text-xl lg:text-3xl py-5">Titre d'article</h1>
            </div>
            <div className="flex flex-col">
                <h3 className=" lg:text-2xl font-bold text-gray-400 ">Résume: </h3>
                <p className="lg:text-2xl py-2 ml-4">Resume Quelque citations a partir du texte intégral exemple: Google Scholar provides a simple across a wide variety of disciplines and sources: articles, theses, ...  </p>
           </div>
           <div className="flex ">
                <h3 className=" lg:text-2xl font-bold text-gray-400 ">Auteurs: </h3>
                <p className="px-3 pt-1.5">Flan , feltan , flan , flan...</p>
           </div>
           <div className="flex">
